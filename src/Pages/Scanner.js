    ...
    <div class="">
      <div class="flex flex-col">
        <div class=" mb-4 relative">
          <div class="text-center font-semibold text-lg">Scanned results</div>
          <div class="flex gap-3 absolute top-1/2 -translate-y-1/2 right-2">
            <button
        ...
        <div
          ...
          class="p-4 sm:px-6 bg-white rounded-lg shadow overflow-auto"
          style={{ height: "640px" }}
        >
          {result}
        </div>
